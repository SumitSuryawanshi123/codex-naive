...
from debug_module.database import get_db, init_db
from debug_module.evidence.store import append_artifact
from debug_module.learning import record_resolution
from debug_module.models import Feedback, Investigation
...
from debug_module.schemas import ArtifactIn, FeedbackIn, InvestigationCreate, InvestigationOut

app = FastAPI(title="DebugOS Investigation Engine")
templates = Jinja2Templates(directory="debug_module/templates")
