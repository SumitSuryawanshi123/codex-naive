...
from app.ingestion.configs import ingest_config_text
from app.ingestion.har import ingest_har_text
from app.ingestion import ingest_text
from app.ingestion.otel import ingest_otel_text
from app.models import Artifact, Evidence
from app.reasoning.patterns import pattern_evidence_from_text
...
def append_artifact(db: Session, investigation_id: int, artifact_type: str, raw_text: str, source_meta: dict) -> Artifact:
    ...
    for candidate in source_evidence_from_text(redacted):
        if candidate.fingerprint in existing_fingerprints:
            continue
